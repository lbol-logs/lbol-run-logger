...
namespace RunLogger.Patches.SaveData
{
    ...
    {
        [HarmonyPatch(typeof(GameRunController), nameof(GameRunController.Create)), HarmonyPostfix]
        private static void StartRun(GameRunStartupParameters parameters, GameRunController __result)
        {
