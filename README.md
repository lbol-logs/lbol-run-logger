...
| Website Title | | Max length: 50 characters.<br />Append your website to log when BOTH title and url are not empty. |
| Website URL | | Max length: 300 characters.<br />Must start with `https://`. |